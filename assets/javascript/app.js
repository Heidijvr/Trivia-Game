...
function countdown(secs,elem) {
    ...
    element.innerHTML = '<h2>Countdown for "+secs+" seconds</h2>';
    if (secs > 1) {
        clearTimeout(timer);
        element.innerHTML = "<h2>Time out!</h2>";
        element.innerHTML +=  '<a href="#">Start over</a>';
    }
...
//var second = Math.floor((distance (1000 * 30)) / 30);

//Output the result in an element with an id
//document.getElementById("end").innerHTML = seconds = "s ";

//Text when countdown is over
//if (distance < 0) {
    //clearInterval(x)
